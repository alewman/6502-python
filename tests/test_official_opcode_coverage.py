...
OFFICIAL_OPCODE_BYTES = {
    ...
    8A 8C 8D 8E 8F 90 91 92 94 95 96 97 98 99 9A 9D A0 A1 A2 A3 A4 A5 A6 A7 A8 A9
    AA AC AD AE AF B0 B1 B2 B3 B4 B5 B6 B7 B8 B9 BA BC BD BE BF C0 C1 C2 C3 C4 C5 C6 C7
    C8 C9 CA CC CD CE CF D0 D1 D2 D3 D4 D5 D6 D7 D8 D9 DA DB DC DD DE DF E0 E1 E2 E3 E4
    E5 E6 E7 E8 E9 EA EC ED EE EF F0 F1 F2 F3 F4 F5 F6 F7 F8 F9 FA FB FC FD FE FF
    """.split()
}
...
def test_official_opcode_set_is_complete_and_dispatches_to_implemented_semantics():
    ...
    assert len(OFFICIAL_OPCODE_BYTES) == 242
